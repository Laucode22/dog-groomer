...
public class LoadData extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("L O A D   D A T A");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        control.saveItem(petName, breed, color, obser, allergies, specialAtten, ownerName, ownPhone);
        
        JOptionPane optionPane = new JOptionPane("Your information was save");
        optionPane.setMessageType(JOptionPane.INFORMATION_MESSAGE);
        JDialog dialog = optionPane.createDialog("Data save");
